...
/**
 * Lzht2 generated by hbm2java
 */
@Entity
@Table(name = "lzht", schema = "public")
public class Lzht2 implements java.io.Serializable {
  ...
  public Lzht2(long id) {
    this.id = id;
  }

  public Lzht2(Lzht1 obj) {
  ...
  public Lzht2(long id, String ycbhtbm, String lzhtbm, String cbfbm, String srfbm, String lzfs, String lzqx, Date lzqxksrq, Date lzqxjsrq, Float lzmj, Integer lzdks, Character lzqtdyt, Character lzhtdyt, String lzjgsm, Date htqdrq, Long orgId) {
    this.id = id;
