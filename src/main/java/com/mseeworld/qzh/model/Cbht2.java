...
/**
 * Cbht2 generated by hbm2java
 */
@Entity
@Table(name="cbht"
    ,schema="public"
)
public class Cbht2  implements java.io.Serializable {
  ...
  private String orgName;
    ...
    public Cbht2(long id, String cbhtbm) {
        this.id = id;
        this.cbhtbm = cbhtbm;
    }
    public Cbht2(long id, String cbhtbm, String ycbhtbm, String fbfbm, String cbfbm, String cbfs, Date cbqxq, Date cbqxz, Float htzmj, Integer cbdkzs, Date qdsj, Long orgId) {
       this.id = id;
       this.cbhtbm = cbhtbm;
  ...
  @SequenceGenerator(name = "cbht_seq", sequenceName = "cbht_id_seq",allocationSize=1)
