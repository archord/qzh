...
/**
 * AOrganization2 generated by hbm2java
 */
@Entity
@Table(name = "a_organization", schema = "public")
public class AOrganization2 implements java.io.Serializable {
  ...
  public AOrganization2() {
  }

  public AOrganization2(long orgId) {
    this.orgId = orgId;
  }

  public AOrganization2(long orgId, long parentId, String orgName, Boolean isDeleted, String orgCoding, String postalCode, String authOrgName, String authPeople, String authPhone, String fbfName, String fbfLegalPerson, String fbfPhone, String fbfAddress, String orgMember, Short regionType, Short orgLevel) {
    this.orgId = orgId;
