...
//          }
      ...
      "fbfwindow button[ref=save]": {
        click: function(btn) {
          var tree = btn.up('fbfwindow').down('people_grid');
      ...
      "cbhtdkgrid button[ref=add]": {
        click: function(btn) {
          ...
          if (parseInt(pform.findField("id").getValue()) > 0) {
            var win = Ext.create("core.view.DkSearchWindow");
            win.show();
          } else {
...
//          }
  ...
  views: [
    ...
    "core.view.CbfGrid",
    "core.view.DkGrid",
    "core.view.OrgTreeCbhtDkSearch"
  ],
  stores: ["core.store.CbhtStore", "core.store.CbhtDkStore", "core.store.OrgStore", "core.store.PeopleStore", "core.store.CbfStore", "core.store.DkStore"],
