Ext.define("core.controller.QzhGenerateController", {
//	mixins:{
...
//          store.filter("id", 0);
      ...
      "qzhGenerateGrid button[ref=add]": {
        click: function(btn) {
          var lzhhtWin = Ext.create("core.view.qzh.QzhGenerateWindow");
          lzhhtWin.show();
        }
      },
...
//                store.load({params: {cbhtId: cbhtId}});
  ...
  views: [
    "core.view.qzh.QzhGenerateLayout",
    "core.view.qzh.OrgTreeQzhGenerate",
    "core.view.qzh.QzhGenerateWindow",
    "core.view.qzh.QzhGenerateGrid",
    "core.view.qzh.OrgTreeQzhGenerate_Cbht",
    "core.view.qzh.QzhCbhtGrid"
  ],
  stores: ["core.store.CbjyqzdjbStore", "core.store.OrgStore", "core.store.CbhtStore_qz"],
  models: ["core.model.CbjyqzdjbModel"]
});