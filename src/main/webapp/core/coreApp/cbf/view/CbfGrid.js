...
Ext.define("core.cbf.view.CbfGrid", {
  ...
  columns: [
    ...
    {text: "承包方类型", dataIndex: "cbflx", width: 80, field: {
        xtype: "textfield"
      }},
    {text: "承包方名称", dataIndex: "cbfmc", width: 80, field: {
        xtype: "textfield"
      }},
    {text: "承包方性别", dataIndex: "cbfxb", width: 80, field: {
        xtype: "textfield"
      }},
    {text: "承包方民族", dataIndex: "cbfmz", width: 80, field: {
        xtype: "textfield"
      }},
    {text: "承包方地址", dataIndex: "cbfdz", width: 150, field: {
        xtype: "textfield"
      }},
