  ...
  listeners: {
    show: function(_this) {
      if (_this.extraParas) {
        ...
        _this.down("form").getForm().findField("lzhtbm").setValue(_this.extraParas.obj.lzhtbm);
        _this.down("form").getForm().findField("cbfbm").setValue(_this.extraParas.obj.cbfbm);
        _this.down("form").getForm().findField("srfbm").setValue(_this.extraParas.obj.srfbm);
        _this.down("form").getForm().findField("lzfs").setValue(_this.extraParas.obj.lzfs);
        _this.down("form").getForm().findField("lzqx").setValue(_this.extraParas.obj.lzqx);
        _this.down("form").getForm().findField("lzqxksrq").setValue(_this.extraParas.obj.lzqxksrq);
        _this.down("form").getForm().findField("lzqxjsrq").setValue(_this.extraParas.obj.lzqxjsrq);
        _this.down("form").getForm().findField("lzmj").setValue(_this.extraParas.obj.lzmj);
        _this.down("form").getForm().findField("lzdks").setValue(_this.extraParas.obj.lzdks);
        _this.down("form").getForm().findField("lzqtdyt").setValue(_this.extraParas.obj.lzqtdyt);
        _this.down("form").getForm().findField("lzhtdyt").setValue(_this.extraParas.obj.lzhtdyt);
        _this.down("form").getForm().findField("lzjgsm").setValue(_this.extraParas.obj.lzjgsm);
        _this.down("form").getForm().findField("htqdrq").setValue(_this.extraParas.obj.htqdrq);
      } else {
